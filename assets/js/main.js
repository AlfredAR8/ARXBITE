(function () {
  ...
  window.onscroll = function () {
    ...
    if (window.pageYOffset > sticky) {
      ...
      logo.style = "width: 130px; height: 110px";
      logoCircle.style.backgroundColor = "transparent";
      logoCircle.style.border = "none";
      logoCircle.style.width = "130px"
      logoCircle.style.height = "110px"
    } else {
      header_navbar.classList.remove("sticky");
      logo.src = "assets/images/logo/logo.png";
      logo.style = "width: 80px; height: 80px";
      logoCircle.style.backgroundColor = "#ffffff"; // Set your circle color again
      logoCircle.style.border = "none";
      logoCircle.style.width = "100px"
      logoCircle.style.height = "100px"
    }
